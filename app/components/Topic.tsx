...
const DESCRIPTIONS: Record<string, string[]> = {
	"Reto empresarial x Cámara de Comercio BAQ": ["¿Y si pudieras mejorar los procesos internos de una empresa real con inteligencia artificial? Esta categoría está diseñada para que equipos corporativos o participantes con visión de negocio trabajen directamente sobre un desafío interno propuesto por una empresa aliada. Con el acompañamiento de mentores expertos, tu equipo podrá optimizar operaciones, automatizar flujos o crear nuevos servicios.", " 🏆 Premio especial: $1.000.000 COP para la mejor solución empresarial."],
